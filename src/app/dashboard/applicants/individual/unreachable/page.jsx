// "/licence-applicants/individual/all/"     =>  "/licence-applicants/individual/all/?status=unreachable"
...
const AllIndividualApplicantsList = () => {
 ...
 <div 
  ...
  async function fetchApplicants() {
    try {
      const response = await axiosInstance.get(
        "/licence-applicants/individual/all/?status=unreachable"
      );
      setLocalApplicantsData(response.data.results);
    } catch (error) {
      console.error("An error occured", error.message);
  ...
  const muiApplicantListData = localApplicantsData.map((applicant, index) => ({
    ...
    date_first_listed_on_website: applicant.date_first_listed_on_website,
...
{deleteModalOpen && (
        ...
        //   </div>
        // </div>
        <DeleteModal selectedRowId={selectedRowId} setDeleteModalOpen={setDeleteModalOpen}/>
      )}
...
export default IsAuth(AllIndividualApplicantsList);
